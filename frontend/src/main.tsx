...
function Guide({ execute }: any) {
  ...
  return <div className="guide-page">
    ...
    <section><div className="section-heading"><div><p className="kicker">METRIC DEFINITIONS</p><h2>What the customer columns mean</h2></div></div><div className="definition-grid">
      ...
      <Definition title="Customer group" technical="Segment" text="A clear combination of two independent facts: relative inactivity risk is high at 65/100 or above, and spend is high at £250 or above. This produces high-spend at risk, lower-spend at risk, high-spend active, and lower-spend active groups."/>
    </div></section>
